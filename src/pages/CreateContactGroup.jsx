...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.mista.io/sms/contacts',
...
let config = {
  ...
  url: 'https://api.mista.io/sms/contacts',
  headers: { 
    'Content-Type': 'application/json', 
    'Authorization': 'Bearer 691|noH3oYAbKckuYpgCq30VPquNTu3kUFnWksIwuaZx'
  },
    ...
    <div className="flex flex-col xl:flex-row  xl:w-[70rem] min-h-screen bg-white px-4 py-10 justify-center items-center xl:mt-2 md:mt-20 xl:ml-auto md:w-[85vw] w-[100vw] -ml-10 dark:bg-black
     ">
      ...
      <div className="w-full xl:w-[70rem] bg-white p-6  rounded-lg  xl:absolute xl:left-[17rem] xl:h-full">
        <h1 className="text-3xl mb-4">Create contact group</h1>
        ...
        <br/>
          ...
          /sms/contacts
          <br/>
          Base URL: <span className="text-blue-500">https://api.mista.io/sms/contacts</span>
        </p>
        ...
        <div className="flex justify-between border-b py-2 my-4">
            ...
            <br/>
            <span className="text-gray-600 text-sm font-thin">Name of the contact group.</span>
            </p>
          </div>
      </div>
